...
namespace PathFinder
{
    ...
    void DenoiserMipGenerationRenderPass::ScheduleResources(ResourceScheduler* scheduler)
    {
        ...
        scheduler->ReadTexture(ResourceNames::StochasticShadowedShadingOutput, { 0 });
        scheduler->ReadTexture(ResourceNames::StochasticUnshadowedShadingOutput, { 0 });
        //scheduler->WriteTexture(ResourceNames::StochasticShadowedShadingOutput, { 1, 2, 3, 4 });
        //scheduler->WriteTexture(ResourceNames::StochasticUnshadowedShadingOutput, { 1, 2, 3, 4 });
    }
